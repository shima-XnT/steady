...
- 追加計算列: `workMinutes`, `workloadScore`, `sleepHours`, `napHours`, `recoveryScore`, `cardioMinutes`, `strengthSetCount`, `completedSetCount`, `totalSetCount`, `completedExerciseCount`, `totalExerciseCount`, `completionRate`
